...
*نحوه استفاده:*
1\\. با /get یا فرستادن عدد کد، یک هنتای خاص را دریافت کنید \\(بدون نیاز به سشن\\)
2\\. برای دسترسی به علاقه‌مندی‌ها، ابتدا با /session سشن را تنظیم کنید
3\\. سپس با /export فایل PDF علاقه‌مندی‌ها را دریافت کنید
4\\. با /filter می‌توانید تگ‌های خاصی را فیلتر کنید
`;
